...
namespace SkierFramework
{
    public class UIViewController
    {
        ...
        public UniTask Load(object userData = null, Action callback = null)
        {
            isLoading = true;
            ...
            return LoadInternal(userData, callback);
        }

        private async UniTask LoadInternal(object userData, Action callback)
        {
            var go = await ResourceManager.Instance.InstantiateAsync(uiPath);
            if (!isLoading)
            {
